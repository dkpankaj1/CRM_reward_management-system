                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <a href="{{route('redeem.show',$redeem)}}" class="btn btn-warning" title="View"><i class="fas fa-eye"></i></a>
                                        <a href="{{route('redeem.payment',$redeem)}}" class="btn btn-info" title="Create Payment"><i class="fas fa-money-bill"></i></a>
